#!/bin/bash
# Database initialization script for Power Monitor
# This script is executed automatically by MySQL Docker on first startup
...
mysql -u root -p"$MYSQL_ROOT_PASSWORD" <<-EOSQL
    ...
    -- Grant privileges
    GRANT ALL PRIVILEGES ON power_real_a_1.* TO '$MYSQL_USER'@'%';
    FLUSH PRIVILEGES;
EOSQL
